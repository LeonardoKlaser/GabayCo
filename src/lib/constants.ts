...
export const UNIFIED_SERVICES: ServiceSectionData[] = [
  {
    id: "planejamento",
    step: "01",
    title: "Planejamento Estratégico",
  ...
  },
  {
    ...
    prose: [
      ...
      },
      {
        ...
        title: "30 dias, 4 fases",
        items: [
          "Fase 1: Leitura do Negócio — entender a empresa por dentro",
          "Fase 2: Pesquisa Orientada — percepção externa",
          "Fase 3: Diagnóstico Estratégico — identificar erros e diferenciais",
          "Fase 4: Direção e Plano de Ação — posicionamento claro e prioridades",
        ],
      },
    ],
    cards: [
    ...
    cards: [
      {
        ...
        items: [
          "Um encontro online",
          "Documento de construção inicial personalizado",
          "Suporte no WhatsApp por 07 dias",
        ],
      },
      {
        tag: "RESULTADO",
    ...
    cards: [
      {
        ...
        title: "Entregáveis",
        items: [
          "Encontro online de 1h",
          "Sistema prático (GPT personalizado) para transformar rotina em conteúdo",
        ],
      },
      {
        tag: "RESULTADO",
